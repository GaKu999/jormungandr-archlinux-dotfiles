...
\e[1;35m│ \e[1;36ml\e[0m\e[1mabwc\e[0m \e[36m-\e[0m \e[1mwayland\e[0m    \e[1;35m│\e[0m
	...
	while true; do
		...
		case $REPLY {
			...
			'l')
				...
				exec systemd-run --user -dqG -EWLR_BACKENDS=drm,libinput,headless --scope -ulabwc-session --slice-inherit -- labwc
			;;
			'c')
				echo -ne "\e[H\e[2J"
