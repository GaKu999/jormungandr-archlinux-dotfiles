...
\e[1;35m│ \e[1;32ml\e[0m\e[1mabwc\e[0m \e[36m-\e[0m \e[1mwayland\e[0m    \e[1;35m│\e[0m
...
EOF
	...
	while true; do
		...
		case "$REPLY" in
			...
			'l')
				echo -ne "\e[H\e[2J"
				_prepare_graphical_environment wayland labwc
				exec systemd-run --user -dqG -EWLR_BACKENDS=headless,libinput,drm --scope -ulabwc-session --slice-inherit -- labwc
			;;
			'c')
				echo -ne "\e[H\e[2J"
